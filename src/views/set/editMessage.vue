      ...
      <div class="createPost-main-container">
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item style="margin-bottom: 40px;" prop="name">
              <MDinput v-model="myPostForm.title" :maxlength="100" name="name" required>
                通知标题
              </MDinput>
            </el-form-item>
        ...
        <el-row>
          <el-form-item style="margin-bottom: 40px;" label-width="45px" label="摘要:">
            <el-input :rows="1" v-model="myPostForm.content_short" type="textarea" class="article-textarea" autosize
                      placeholder="请输入内容"/>
          </el-form-item>
        </el-row>
        <el-row>
  ...
  export default {
    ...
    methods: {
      ...
      submitForm() {
        ...
        if (this.myPostForm.title == '') {
          this.$message({
            type: 'error',
            message: '标题不能为空！'
          });
        }
        else if (this.myPostForm.content == '') {
          this.$message({
            type: 'error',
            message: '内容不能为空！'
          });
        } else {
          updateMessage(this.myPostForm).then(response => {
