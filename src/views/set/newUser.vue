    ...
    <el-form ref="postForm" :model="postForm" :rules="rules" class="form-container">
      ...
      <div class="createPost-main-container" style="width: 500px">
        ...
        <el-form-item style="margin-bottom: 40px;" label-width="100px" label="手机号(账号):">
          <el-input :rows="1" v-model="myPostForm.username" type="number" class="article-textarea" autosize
                    placeholder="请输入手机号"/>
        </el-form-item>

        <el-form-item style="margin-bottom: 40px;" label-width="100px" label="昵称:">
          <el-input :rows="1" v-model="myPostForm.nickname" type="text" class="article-textarea" autosize
                    placeholder="请输入昵称"/>
          <span v-show="contentShortLength" class="word-counter">{{ contentShortLength }}字</span>
        </el-form-item>

        <el-form-item style="margin-bottom: 40px;" label-width="100px" label="姓名:">
          <el-input :rows="1" v-model="myPostForm.name" type="text" class="article-textarea" autosize
                    placeholder="请输入姓名"/>
          <span v-show="contentShortLength" class="word-counter">{{ contentShortLength }}字</span>
        </el-form-item>

        <el-form-item style="margin-bottom: 40px;" label-width="100px" label="密码:">
          <el-input :rows="1" v-model="myPostForm.password" type="password" class="article-textarea" autosize
                    placeholder="请输入密码"/>
        </el-form-item>


        <el-form-item style="margin-bottom: 40px;" label-width="100px" label="确认密码:">
          <el-input :rows="1" v-model="myPostForm.repeatPassword" type="password" class="article-textarea" autosize
                    placeholder="请确认密码"/>
        </el-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      submitForm() {
        ...
        else if (this.myPostForm.password < 6) {
          this.$message({
            type: 'error',
            message: '密码必须大于6位！'
          });
